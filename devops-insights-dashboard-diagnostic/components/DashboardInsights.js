...
export default function DashboardInsights() {
  console.log("✅ Renderizando DashboardInsights");
  ...
  const fetchInsights = async () => {
    console.log("📡 Chamando API com:", { sprint, board, idsEstimados });
    try {
  ...
  return (
    <div className="p-6 space-y-6 text-white">
      ...
      <div className="text-green-300 font-bold">🟢 Dashboard está vivo e renderizado</div>
